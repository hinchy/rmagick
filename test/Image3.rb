...
class Image3_UT < Test::Unit::TestCase
  ...
  def test_quantum_operator
    quantum_ops = [
      Magick::UndefinedQuantumOperator,
      ...
      Magick::LeftShiftQuantumOperator,
      Magick::LogQuantumOperator,
      Magick::MaxQuantumOperator,
      Magick::MeanQuantumOperator,
      Magick::MedianQuantumOperator,
      Magick::MinQuantumOperator,
      ...
      Magick::RightShiftQuantumOperator,
      Magick::RootMeanSquareQuantumOperator,
      Magick::SetQuantumOperator,
