...
//  rb_define_method(Class_Image, "plasma", Image_plasma, 6);
    ...
    DEF_ENUM(MetricType)
        ...
        ENUMERATOR(StructuralSimilarityErrorMetric)
        ENUMERATOR(StructuralDissimilarityErrorMetric)
    END_ENUM
    ...
    DEF_ENUM(QuantumExpressionOperator)
        ...
        ENUMERATOR(LeftShiftQuantumOperator)
        ...
        ENUMERATOR(RightShiftQuantumOperator)
